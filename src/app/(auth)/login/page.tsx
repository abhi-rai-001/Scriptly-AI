...
export const metadata = {
  title: "Sign In | Scriptly AI",
  description: "Sign in to your Scriptly AI account and start generating viral content.",
};
        ...
        <div className="flex flex-col gap-1.5">
          <div className="flex items-center justify-between">
            ...
            <Link
              ...
              className="text-xs font-medium text-[oklch(0.72_0.20_285)] hover:text-[oklch(0.62_0.24_285)] transition-colors"
            >
              Forgot password?
            </Link>
          </div>
