...
- **Button Component**: The project's Button component uses Base UI's render prop for element composition. Never use asChild with the Button component; use render={<Link ... />} instead.
